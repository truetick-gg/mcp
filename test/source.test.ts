...
// `truetick-mcp` runs as plain Node ESM, which takes a relative specifier as
// written: "./client" is not "./client.js". tsc (moduleResolution "bundler")
// emits the short form verbatim and vitest fills in the extension, so the build
// and this suite pass while the server dies at startup with
